								...
								<div class="woocommerce">
									<nav class="woocommerce-MyAccount-navigation">
										<ul>
											...
											<li >
                                                                                                <a href="account_details.html">帐户详情</a>
                                                                                        <li >
											<li >
									...
									<div class="woocommerce-MyAccount-content">
										<form class="edit-account" action="" method="post">
											<p class="form-row form-row-first">
												...
												<input type="text" class="input-text" name="account_name" id="account__name"/>
											</p>
											...
											<p class="form-row form-row-wide">
												...
												<input type="email" class="input-text" name="account_email" id="account_email" value="test@sina.com" />
											</p>
										  
											<fieldset>
												<legend>修改密码</legend>
												<p class="form-row form-row-wide">
													<label for="password_current">当前密码</label>
											...
											<div class="clear"></div>
											<p>
												<input type="submit" class="button" name="save_account_details" value="保存" />
											</p>
										</form>
									</div>
								</div>
